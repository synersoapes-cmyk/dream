                ...
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <div className="mt-1 text-xs leading-6 text-slate-300">
                      当前角色的 OCR
                      面板真值与手动校准值。这里主要维护人物基础档案，不直接代表换装推演结果。
                    </div>
                  </div>
              ...
              <div className="rounded-xl border border-yellow-800/30 bg-yellow-950/10 p-4">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <div className="mt-1 text-xs leading-6 text-slate-300">
                      经脉、装备、修炼、神器等变化会在基线之上联动到当前面板。右侧攻击/防御区看到的是“基线
                      + 增量”的结果。
                    </div>
                  </div>
            ...
            <div className="rounded-xl border border-cyan-800/30 bg-slate-900/40 p-4">
              <div className="mb-3 flex items-center justify-between gap-3 border-b border-cyan-800/20 pb-2">
                <div>
                  ...
                  <div className="mt-1 text-[11px] text-slate-400">
                    先看关键面板项的主要增量来自哪里。这里展示的是“当前结果”相对
                    OCR 基线的来源拆解。
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3 xl:grid-cols-3">
                {panelSourceBreakdowns.map((item) => {
                  const summary = buildPanelSourceBreakdownSummary(item, 2);
                ...
                <div className="mt-4 rounded-xl border border-yellow-800/30 bg-slate-950/40 p-3">
                  ...
                  <div className="mt-3 flex items-center gap-2">
                    <button
                      ...
                      onClick={() =>
                        setAllocationAmount(
                          Math.max(0, baseAttributes.potentialPoints)
                        )
                      }
                      type="button"
                    >
                    ...
                    <button
                      ...
                      disabled={
                        allocationAmount <= 0 ||
                        baseAttributes.potentialPoints <= 0
                      }
              ...
              <div className="rounded-xl border border-yellow-800/40 bg-slate-900/40 p-4">
                ...
                <div className="space-y-1">
                  ...
                  <AttributeDisplay
                    ...
                    onValueChange={(v) =>
                      updateCombatStat('elementalMastery', v)
                    }
                  />
                </div>
              </div>
              ...
              <div className="rounded-xl border border-yellow-800/40 bg-slate-900/40 p-4">
                ...
                <div className="space-y-1">
                  ...
                  <AttributeDisplay
                    ...
                    onValueChange={(v) =>
                      updateCombatStat('sealResistLevel', v)
                    }
                  />
                  <AttributeDisplay
                    label="躲避"
